...
public class AutoDoSwitch {
  ...
  public AutoDoSwitch(Drive drive, Lift lift, Manipulator manipulator,
    ...
    mNavigatorPID.setTunings(
        0.02, 0.0001,
        0.005); //(0.035, 0.00007, 0.004); // For comp robot: (0.02, 0, 0.005);
  }
