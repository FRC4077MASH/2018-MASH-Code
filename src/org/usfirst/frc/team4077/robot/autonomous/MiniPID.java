...
public class MiniPID {
  ...
  public void setDirection(boolean reversed) { this.reversed = reversed; }
  ...
  public double getOutput(double actual, double setpoint) {
    ...
    if (setpointRange != 0) {
      setpoint =
          constrain(setpoint, actual - setpointRange, actual + setpointRange);
    }
    ...
    if (minOutput != maxOutput && !bounded(output, minOutput, maxOutput)) {
      errorSum = error;
               ...
               !bounded(output, lastOutput - outputRampRate,
    ...
    if (outputRampRate != 0) {
      output = constrain(output, lastOutput - outputRampRate,
                         lastOutput + outputRampRate);
    }
  ...
  public double getOutput() { return getOutput(lastActual, setpoint); }

  public double getOutput(double actual) { return getOutput(actual, setpoint); }
  ...
  public void setOutputRampRate(double rate) { outputRampRate = rate; }

  public void setSetpointRange(double range) { setpointRange = range; }
